...
public class S028_aula01_creditcard_v02 {
 ...
 // Instance variables:
  protected String customer;      // name of the customer (e.g., "John Bowman")
  protected String bank;          // name of the bank (e.g., "California Savings")
  protected String account;       // account identifier (e.g., "5391 0375 9387 5309")
  protected int limit;            // credit limit (measured in dollars)  
